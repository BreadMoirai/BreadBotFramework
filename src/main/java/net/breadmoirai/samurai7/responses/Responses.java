 ...
 */
package net.breadmoirai.samurai7.responses;

import net.breadmoirai.samurai7.core.response.BasicResponse;
import net.breadmoirai.samurai7.responses.menu.PromptBuilder;
import net.breadmoirai.samurai7.responses.menu.ReactionMenuBuilder;
