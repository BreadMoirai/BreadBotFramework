 ...
 *
 */
package net.breadmoirai.samurai7.modules.prefix;

import net.breadmoirai.samurai7.core.engine.Command;
import net.breadmoirai.samurai7.core.engine.CommandEvent;
import net.breadmoirai.samurai7.core.engine.Key;
import net.breadmoirai.samurai7.core.response.Response;
import net.breadmoirai.samurai7.responses.Responses;
import net.breadmoirai.samurai7.util.DiscordPatterns;
