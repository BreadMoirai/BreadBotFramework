 ...
 *
 */
package net.breadmoirai.samurai7;

import net.breadmoirai.samurai7.core.IModule;
import net.breadmoirai.samurai7.core.engine.CommandEngine;
import net.breadmoirai.samurai7.core.engine.CommandEngineConfiguration;
import net.breadmoirai.samurai7.modules.admin.AdminModule;
import net.breadmoirai.samurai7.modules.admin.IAdminModule;
import net.breadmoirai.samurai7.modules.prefix.PrefixModule;
import net.breadmoirai.samurai7.modules.source.Source;
import net.breadmoirai.samurai7.modules.source.SourceModule;
...
public class SamuraiBuilder {
    ...
    /**
     * If this is set, the {@link Source @Source} annotation is enabled. Command classes marked with this annotation is restricted to usage within the set guild.
     ...
     * </ul>
     *
     * This behavior can be changed by extending the {@link AdminModule} like the following:
     * <pre><code>
     * {@link SamuraiBuilder samuraiBuilder}.addModule(new MyAdminModule());
     * ...
     * public class MyAdminModule implements {@link IAdminModule} {
     *    {@literal @}Override
