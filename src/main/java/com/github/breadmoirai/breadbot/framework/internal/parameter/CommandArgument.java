...
//            * <p>If this argument is an {@link net.dv8tion.jda.core.entities.Emote}, the method will return {@code true}. However, if the {@link net.dv8tion.jda.core.entities.Emote} is not a valid {@link net.dv8tion.jda.core.JDA} entity, it will NOT be reflected in this method. Instead the object returned by {@link com.github.breadmoirai.bot.framework.event.args.CommandArgument#getEmote} will return an {@link net.dv8tion.jda.core.entities.Emote} with {@link net.dv8tion.jda.core.entities.IFakeable#isFake() isFake()} returning {@code true}
    ...
    /**
     * Equivalent to {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isNumeric isNumeric()} but also checks that the number is within the range of an integer
     *
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isInteger isInteger()} returns {@code false}
     */
     ...
     *
     * @return a float
     * @throws NumberFormatException if {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isFloat() isFloat()} returns {@code false}
     */
     ...
     * <p><b>This method CAN be used in cases where {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isRange isRange()} would return false.</b> If the argument is a single integer, where {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isInteger isInteger()} would return {@code true}, an {@link java.util.stream.IntStream} with a single value will be returned.
     *
     * @return an ordered {@link java.util.stream.IntStream}. If {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isRange isRange()} AND {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isInteger isInteger()} would return false, An empty IntStream will be returned.
     */
    @NotNull
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isHex isHex()} would return false
     */
     ...
     * <p>
     * If this method returns {@code false} and {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isUser} returns {@code true}, this CommandArgument is can be cast to an  {@link com.github.breadmoirai.breadbot.framework.internal.parameter.argument.InvalidMentionArgument InvalidMentionArgument}
     *
     ...
     * <pre><code>
     *     return {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#getEmoji}() != null
     * </code></pre>
     *
