...
public class ArgumentParserImpl implements ArgumentParser {
    ...
    public Object parse(CommandParameter parameter, CommandArgumentList list, CommandParser parser) {
        ...
        boolean mustBePresent = parameter.mustBePresent();
        AbsentArgumentHandler absentArgumentHandler = parameter.getAbsentArgumentHandler();
        TypeParser<?> typeParser = parameter.getTypeParser();
