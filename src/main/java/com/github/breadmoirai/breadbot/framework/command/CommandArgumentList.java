...
import com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgumentFactory;
...
public class CommandArgumentList extends AbstractList<CommandArgument> {
     ...
     *
     * @param types the {@link java.util.Spliterator} will only see {@link com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgument CommandArguments} that satisfy at least one of the types provided.
    ...
    /**
     * Attempts to match each {@link com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgument} to a {@link ArgumentTypeMapper} in the order passed.
     ...
     * @return {@code true} if the {@link ArgumentTypeMapper ArgumentTypes} provided match the {@link com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgument CommandArguments} in this list with {@link com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgument#isOfType(Class)}
     */
