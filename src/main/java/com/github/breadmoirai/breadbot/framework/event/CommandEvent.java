...
public abstract class CommandEvent extends Event {
    ...
    /**
     * retrieves a {@link com.github.breadmoirai.breadbot.framework.command.parameter.CommandArgument} from the {@link CommandArgumentList} returned by {@link com.github.breadmoirai.breadbot.framework.event.CommandEvent#getArguments()}
     *
     * @param index the index of the argument starting at 0. This does not include the key.
     * @return the non-null CommandArgument
     * @throws IndexOutOfBoundsException if the index is less than 0 or greater than {@link com.github.breadmoirai.breadbot.framework.event.CommandEvent#getArgumentCount()}
     */
    ...
    /**
     * Calls {@link com.github.breadmoirai.breadbot.framework.event.CommandEvent#getArguments(int)} with the default limit.
     *
     * @return a CommandArgumentList
     * @see com.github.breadmoirai.breadbot.framework.event.CommandEvent#getArguments(int)
     * @see com.github.breadmoirai.breadbot.framework.event.CommandEvent#setDefaultArgumentLimit
     */
     ...
     * recommended to use {@link com.github.breadmoirai.breadbot.framework.event.CommandEvent#getArguments(int)} instead.
     *
     * @param limit the split limit
     *
     * @return a new {@link CommandArgumentList}.
