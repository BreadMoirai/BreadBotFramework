...
public class CommandArgumentList extends AbstractList<CommandArgument> implements RandomAccess {
    ...
    /**
     * Attempts to match each {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument} to a {@link ArgumentTypeMapper} in the order passed.
     ...
     * @return {@code true} if the {@link ArgumentTypeMapper ArgumentTypes} provided match the {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument CommandArguments} in this list with {@link com.github.breadmoirai.breadbot.framework.internal.parameter.CommandArgument#isOfType(Class)}
     */
