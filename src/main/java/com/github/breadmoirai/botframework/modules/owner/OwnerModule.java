 ...
 */
package com.github.breadmoirai.botframework.modules.owner;
...
/**
 * Commands annotated with {@link com.github.breadmoirai.botframework.modules.owner.Owner @Owner} will only activate if the id provided to the constructor matches the user who sent the command.
 */
