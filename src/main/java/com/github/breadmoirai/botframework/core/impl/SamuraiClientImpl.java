...
import com.github.breadmoirai.botframework.core.*;
...
public class SamuraiClientImpl implements SamuraiClient {
     ...
     * Finds and returns the first Module that is assignable to the provided {@code moduleClass}
     *
     * @param moduleName the name of the module to find. If the module does not override {@link com.github.breadmoirai.botframework.core.IModule#getName IModule#getName} the name of the class is used.
