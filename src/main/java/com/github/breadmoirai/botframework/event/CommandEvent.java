...
import com.github.breadmoirai.botframework.core.response.menu.PromptBuilder;
import com.github.breadmoirai.botframework.core.response.menu.ReactionMenuBuilder;
import com.github.breadmoirai.botframework.core.response.simple.EmbedResponse;
import com.github.breadmoirai.botframework.core.response.simple.MessageResponse;
import com.github.breadmoirai.botframework.core.response.simple.ReactionResponse;
import com.github.breadmoirai.botframework.core.response.simple.StringResponse;
import com.github.breadmoirai.botframework.event.args.CommandArgument;
import com.github.breadmoirai.botframework.event.args.CommandArgumentList;
import com.github.breadmoirai.botframework.util.DiscordPatterns;
import com.github.breadmoirai.botframework.util.UnknownEmote;
...
public abstract class CommandEvent extends Event {
    ...
    /**
     * retrieves a {@link com.github.breadmoirai.botframework.event.args.CommandArgument} from the {@link com.github.breadmoirai.botframework.event.args.CommandArgumentList} returned by {@link com.github.breadmoirai.botframework.event.CommandEvent#getArguments()}
     *
     * @param index the index of the argument starting at 0. This does not include the key.
     * @return the non-null CommandArgument
     * @throws IndexOutOfBoundsException if the index is less than 0 or greater than {@link com.github.breadmoirai.botframework.event.CommandEvent#getArgumentCount()}
     */
    ...
    /**
     * Calls {@link com.github.breadmoirai.botframework.event.CommandEvent#getArguments(int)} with the default limit.
     *
     * @return a CommandArgumentList
     * @see com.github.breadmoirai.botframework.event.CommandEvent#getArguments(int)
     * @see com.github.breadmoirai.botframework.event.CommandEvent#setDefaultArgumentLimit
     */
