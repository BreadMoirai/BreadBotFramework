...
import com.github.breadmoirai.botframework.event.Arguments;
import com.github.breadmoirai.botframework.util.Emoji;
...
public interface CommandArgument {
     ...
     * @see com.github.breadmoirai.botframework.event.args.CommandArgument#getTextChannel
     */
    ...
    /**
     * Equivalent to {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isNumeric isNumeric()} but also checks that the number is within the range of an integer
     *
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isInteger isInteger()} returns {@code false}
     */
     ...
     *
     * @return a float
     * @throws NumberFormatException if {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isFloat() isFloat()} returns {@code false}
     */
     ...
     * <p><b>This method CAN be used in cases where {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isRange isRange()} would return false.</b> If the argument is a single integer, where {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isInteger isInteger()} would return {@code true}, an {@link java.util.stream.IntStream} with a single value will be returned.
     *
     * @return an ordered {@link java.util.stream.IntStream}. If {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isRange isRange()} AND {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isInteger isInteger()} would return false, An empty IntStream will be returned.
     */
    @NotNull
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isHex isHex()} would return false
     */
     ...
     * If {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isRole isRole()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
     ...
     *
     * <p>If {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isTextChannel isTextChannel()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
     ...
     *
     * <p>If {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isEmote isEmote()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
    ...
    /**
     * Will attempt to match this argument against the emojis found in {@link com.github.breadmoirai.botframework.util.Emoji} using their unicode value.
     * The implementation of this method is
     * <pre><code>
     *     return {@link com.github.breadmoirai.botframework.event.args.CommandArgument#getEmoji}() != null
     * </code></pre>
     *
     * @return {@code true} if an {@link com.github.breadmoirai.botframework.util.Emoji} was successfully matched.
     */
    boolean isEmoji();

    /**
     * Attempts to find a matching {@link com.github.breadmoirai.botframework.util.Emoji} with {@link com.github.breadmoirai.botframework.util.Emoji#find(String)}
     *
     * @return The {@link com.github.breadmoirai.botframework.util.Emoji} if matched, null otherwise.
     */
    @Nullable
    Emoji getEmoji();
}
