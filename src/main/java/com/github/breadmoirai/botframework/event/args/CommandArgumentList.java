...
/**
 * A list implementation for {@link com.github.breadmoirai.botframework.event.args.CommandArgument CommandArguments} that includes a specialized iterator. All arguments are in lowercase.
 */
public class CommandArgumentList extends AbstractList<CommandArgument> {
    ...
    /**
     * Attempts to match each {@link com.github.breadmoirai.botframework.event.args.CommandArgument} to a {@link com.github.breadmoirai.botframework.event.args.ArgumentType} in the order passed.
     * Will automatically fail if the amount of {@link com.github.breadmoirai.botframework.event.args.ArgumentType ArgumentTypes} provided is greater than the amount of arguments passed.
     *
     * @param types the types of which to look for.
     * @return {@code true} if the {@link com.github.breadmoirai.botframework.event.args.ArgumentType ArgumentTypes} provided match the {@link com.github.breadmoirai.botframework.event.args.CommandArgument CommandArguments} in this list with {@link com.github.breadmoirai.botframework.event.args.CommandArgument#isOfType(ArgumentType)}
     */
     ...
     *
     * @param type The {@link com.github.breadmoirai.botframework.event.args.ArgumentType} to search for.
