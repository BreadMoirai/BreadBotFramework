...
public class CommandEngineBuilder {
     ...
     * {@link com.github.breadmoirai.bot.framework.core.command.ICommand} object
     * to perform it's action whenever it is called.
     *
     * @param command an object ICommand
     * @param keys    keys which trigger the command
     * @return this
     * @see com.github.breadmoirai.bot.framework.core.impl.CommandEngineBuilder#registerCommand(java.lang.Class)
     * @see com.github.breadmoirai.bot.framework.core.impl.CommandEngineBuilder#registerCommand(java.lang.Object)
     */
