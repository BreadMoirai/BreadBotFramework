...
//            * <p>If this argument is an {@link net.dv8tion.jda.core.entities.Emote}, the method will return {@code true}. However, if the {@link net.dv8tion.jda.core.entities.Emote} is not a valid {@link net.dv8tion.jda.core.JDA} entity, it will NOT be reflected in this method. Instead the object returned by {@link com.github.breadmoirai.bot.framework.event.args.CommandArgument#getEmote} will return an {@link net.dv8tion.jda.core.entities.Emote} with {@link net.dv8tion.jda.core.entities.IFakeable#isFake() isFake()} returning {@code true}
    ...
    /**
     * @see com.github.breadmoirai.bot.framework.command.parser.ArgumentTypes#isOfType(java.lang.Class, com.github.breadmoirai.bot.framework.command.parser.CommandArgument)
     *
    ...
    /**
     * @see com.github.breadmoirai.bot.framework.command.parser.ArgumentTypes#isOfType(java.lang.Class, com.github.breadmoirai.bot.framework.command.parser.CommandArgument, int)
     *
    ...
    /**
     * Equivalent to {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isNumeric isNumeric()} but also checks that the number is within the range of an integer
     *
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isInteger isInteger()} returns {@code false}
     */
     ...
     *
     * @return a float
     * @throws NumberFormatException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isFloat() isFloat()} returns {@code false}
     */
     ...
     * <p><b>This method CAN be used in cases where {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isRange isRange()} would return false.</b> If the argument is a single integer, where {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isInteger isInteger()} would return {@code true}, an {@link java.util.stream.IntStream} with a single value will be returned.
     *
     * @return an ordered {@link java.util.stream.IntStream}. If {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isRange isRange()} AND {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isInteger isInteger()} would return false, An empty IntStream will be returned.
     */
    @NotNull
     ...
     *
     * @return an int
     * @throws NumberFormatException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isHex isHex()} would return false
     */
     ...
     *
     * If this method returns {@code false} and {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isUser} returns {@code true}, this CommandArgument is can be cast to an  {@link com.github.breadmoirai.bot.framework.command.parser.impl.InvalidMentionArgument InvalidMentionArgument}
     *
     ...
     *
     * @throws UnsupportedOperationException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isValidUser()} would return {@code false}
     */
    @NotNull
     ...
     * If {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isRole isRole()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
     ...
     *
     * @throws UnsupportedOperationException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isValidRole()} would return {@code false}
     */
    @NotNull
     ...
     *
     * If this method returns {@code false} and {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isTextChannel()} returns {@code true}, this CommandArgument is can be cast to an  {@link com.github.breadmoirai.bot.framework.command.parser.impl.InvalidMentionArgument InvalidMentionArgument}
     *
     ...
     *
     * <p>If {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isTextChannel isTextChannel()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
     * @return {@link net.dv8tion.jda.core.entities.TextChannel} if can be resolved to a JDA entity
     *
     * @throws UnsupportedOperationException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isValidTextChannel()} would return {@code false}
     */
    @NotNull
     ...
     *
     * <p>If {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isEmote isEmote()} would return true, it is guaranteed that this method returns a {@code non-null} value.
     *
     * @return An {@link net.dv8tion.jda.core.entities.Emote} if the formatting is correct. Otherwise {@code null}.
     *
     * @throws UnsupportedOperationException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isEmote()} would return {@code false}
     */
    @NotNull
     ...
     * <pre><code>
     *     return {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#getEmoji}() != null
     * </code></pre>
     *
     ...
     *
     * @throws UnsupportedOperationException if {@link com.github.breadmoirai.bot.framework.command.parser.CommandArgument#isEmoji()} would return {@code false}
     */
    @NotNull
