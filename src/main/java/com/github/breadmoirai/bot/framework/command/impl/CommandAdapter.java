...
//@Deprecated
//public class CommandAdapter extends CommandWrapper {
//
...
//        if (!hasClassKey) {
//            return handleMap.get(event.getKey().toLowerCase()).handle(commandObj, event, 0);
//        } else {
//            if (event.getArgumentCount() >= 1) {
//                final CommandMethod commandHandle = handleMap.get(event.getArgumentAt(0).getArgument());
//                if (commandHandle != null)
//                    return commandHandle.handle(commandObj, event, 1);
//            }
//            final CommandMethod defaultHandle = handleMap.get("");
//            if (defaultHandle != null) return defaultHandle.handle(commandObj, event, 1);
//        }
//        return false;
//    }
//
