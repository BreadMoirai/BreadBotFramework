...
public final class ArgumentTypes {
    ...
    /**
     * This ignores flags. Use {@link com.github.breadmoirai.bot.framework.command.parser.ArgumentTypes#registerArgumentMapper} otherwise.
     *
     * @param type      The type class
     ...
     * @param flags any {@link com.github.breadmoirai.bot.framework.command.parser.ArgumentFlags flags}
     * @param <T>   the type
     ...
     * <pre><code>
     *     {@link com.github.breadmoirai.bot.framework.command.parser.ArgumentTypes#getAsType(java.lang.Class, com.github.breadmoirai.bot.framework.command.parser.CommandArgument, int) getAsType(type, arg, flags)}.isPresent();
     * </code></pre>
     */
     ...
     * Implemented as
     * <pre><code>
     *     {@link com.github.breadmoirai.bot.framework.command.parser.ArgumentTypes#isOfType(java.lang.Class, com.github.breadmoirai.bot.framework.command.parser.CommandArgument, int) isOfType(type, arg, 0)}
     * </code></pre>
     */
