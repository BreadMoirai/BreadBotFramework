...
/**
 * This class provided behavior to map a {@link com.github.breadmoirai.bot.framework.command.parameter.CommandArgument} to a specified Type.
...
public interface ArgumentTypeMapper<T> extends BiFunction<CommandArgument, Integer, Optional<T>> {
    ...
    /**
     * Maps / Parses the {@link com.github.breadmoirai.bot.framework.command.parameter.CommandArgument} to this given type.
     * This method should never return a null value.
     *
     * @param arg The {@link com.github.breadmoirai.bot.framework.command.parameter.CommandArgument} to be mapped.
